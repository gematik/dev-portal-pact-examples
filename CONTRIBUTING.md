...
2. Fill the pull request template so that we can review your PR. This template
   ...
   pull request.
3. Remember to
   [link the PR to the issue](https://docs.github.com/en/issues/tracking-your-work-with-issues/linking-a-pull-request-to-an-issue)
...
9. You may merge the Pull Request once you have the sign-off of two other
